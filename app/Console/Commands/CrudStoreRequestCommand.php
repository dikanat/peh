...
class CrudStoreRequestCommand extends GeneratorCommand {
    ...
    protected function getStub() {
        ...
        ? config('crudgenerator.path') . '/storerequest.stub'
        : __DIR__ . '/../stubs/storerequest.stub';
    }

    protected function getDefaultNamespace($rootNamespace) {
      return $rootNamespace . '\\' . ($this->option('controller-namespace') ? $this->option('controller-namespace') : 'Http\Requests\Backend\Main');
    }
